...
#ifndef _ExportResponse_H_
#define _ExportResponse_H_
...
/*! \brief Export Response.
 *
 */

class ExportResponse : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportResponse();
	ExportResponse(char* str);
