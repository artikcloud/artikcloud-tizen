...
#ifndef _ExportRequestInfo_H_
#define _ExportRequestInfo_H_
...
/*! \brief Export Request Info.
 *
 */

class ExportRequestInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	ExportRequestInfo();
	ExportRequestInfo(char* str);
	
	/*! \brief Destructor.
	 */
	virtual ~ExportRequestInfo();
